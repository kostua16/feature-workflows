...
description: |-
  ...
  <example>
  user: "Create a new configuration file with these settings"
  assistant: "I'll use the file-writer agent to create the file."
  <commentary>
  The user wants to create a file, so use the file-writer agent.
  </commentary>
  </example>
