...
description: |-
  ...
  <example>
  user: "Add a task to refactor the payment processing module"
  assistant: "I'll use the todo-store agent to add that task."
  <commentary>
  The user wants to manage tasks, so use the todo-store agent.
  </commentary>
  </example>
