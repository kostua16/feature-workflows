...
description: |-
  ...
  <example>
  user: "What does our project documentation say about the deployment process?"
  assistant: "I'll use the project-knowledge-consultant agent to find that information."
  <commentary>
  The user needs to consult project knowledge, so use the project-knowledge-consultant agent.
  </commentary>
  </example>
