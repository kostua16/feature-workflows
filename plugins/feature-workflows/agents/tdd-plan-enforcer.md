...
description: |-
  ...
  <example>
  user: "Create a TDD-compliant plan for the authentication feature"
  assistant: "I'll use the tdd-plan-enforcer agent to create the plan."
  <commentary>
  The user needs TDD compliance, so use the tdd-plan-enforcer agent.
  </commentary>
  </example>
