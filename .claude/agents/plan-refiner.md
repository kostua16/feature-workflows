...
description: |-
  ...
  <example>
  user: "Refine the implementation plan to address the performance concerns"
  assistant: "I'll use the plan-refiner agent to improve the plan."
  <commentary>
  The user needs plan refinement, so use the plan-refiner agent.
  </commentary>
  </example>
