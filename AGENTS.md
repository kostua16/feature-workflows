...
This repo IS a Codex plugin marketplace (`.Codex-plugin/marketplace.json`) shipping the
...
- Always spawn 'knowledge-persist' agent to capture and persist session findings (gaps, issues, evidences, recommendations, review rejects, patterns, gotchas, or any actionable knowledge) into AGENTS.md and Serena memories for future sessions and agents to learn from.
